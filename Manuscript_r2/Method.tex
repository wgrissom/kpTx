...
for a 10 {\textmu}s dwell time and subject to the scanner's gradient amplitude and slew rate constraints of 200 mT/m and 700 T/m/s, respectively (Figure \ref{fig:Target}c). 
...
the dimensions of the $\bm{W}$ matrix were 25,008 RF pulse samples, 
...
This yielded pulse durations of 20.7 ms (reduction factor 0.5), 5.2 ms (reduction factor 2), and 2.7 ms (reduction factor 4).} \revbox{R2.1}
