...
and it was compared to the spatial domain pulse design method in terms of computation time, excitation error,
...
\begin{figure}[!h]
	...
	(c) Computation time (blue axis) and RMSE (red axis) versus inclusion width, for patch widths of 4 cycles/FOV, and 16 threads.}
