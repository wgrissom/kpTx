...
As inclusion width increases, more excitation trajectory points are used in the solution of each target location,
until the entire trajectory is used for each point (Inclusion width = $\infty$ in the table),
