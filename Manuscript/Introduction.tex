...
The spatial domain system matrix typically has dimensions $N_s \times (N_{coils} \cdot N_t)$, 
where $N_s$ is the number of spatial and spectral locations defined in the target excitation pattern,
$N_{coils}$ is the number of transmit channels, and $N_t$ is the number of time points in the pulse.
