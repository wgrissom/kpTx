...
the latter method alternates between small-tip-angle designs that could be solved by the k-space method and Bloch simulations to update the target pattern.} \revbox{R2.X}
