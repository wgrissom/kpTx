...
\textcolor{blue}{nearly all small-tip-angle parallel transmission studies have been formulated in the spatial domain \cite{padormo:2016,deniz:2019}.} \revbox{R2.2}
...
making it infeasible to construct and invert on most modern computers. } \revbox{R2.X}
...
that directly relates the Fourier transform \textcolor{blue}{of a complex-valued}\revbox{R1.1} target excitation pattern to the RF pulses that produce it.
